...
const file_api_annotations_proto_rawDesc = "" +
	"\n" +
	"\x15api/annotations.proto\x12\n" +
	"google.api\x1a\x0eapi/http.proto\x1a google/protobuf/descriptor.proto:K\n" +
	"\x04http\x12\x1e.google.protobuf.MethodOptions\x18\xb0ʼ\" \x01(\v2\x14.google.api.HttpRuleR\x04httpBO\n" +
	"\x0ecom.google.apiB\x10AnnotationsProtoP\x01Z\"github.com/pbuser/genproto/api;api\xa2\x02\x04GAPIb\x06proto3"
