...
const file_api_http_proto_rawDesc = "" +
	...
	"\x04path\x18\x02 \x01(\tR\x04pathBH\n" +
	"\x0ecom.google.apiB\tHttpProtoP\x01Z\"github.com/pbuser/genproto/api;api\xa2\x02\x04GAPIb\x06proto3"
...
func file_api_http_proto_init() {
	...
	file_api_http_proto_msgTypes[1].OneofWrappers = []any{
		(*HttpRule_Get)(nil),
		(*HttpRule_Put)(nil),
		(*HttpRule_Post)(nil),
		(*HttpRule_Delete)(nil),
